...
if(!video) {
    ...
    if(!videoUrl) {
        ...
        var base = videoUrl.match(/https:\/\/v\.redd\.it\/.{1,100}\//)[0]
        ...
        audioElement.insertAdjacentHTML('afterend', '<br><input type="range" min="0" max="100" value="100" class="slider" id="FRP-volumeSlider" style="display: inline-block">')
